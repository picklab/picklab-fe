  ...
  return (
    <span
      className={clsx(
        ...
        {
          'bg-danger-5 text-danger-50 w-space-16 h-space-16': type === 'new',
          'bg-gray-10 text-gray-60 w-space-16 h-space-16': type === 'default',
          'bg-info-5 text-info-50 w-7 h-space-16': type === 'down',
          'bg-danger-5 text-danger-50 w-7 h-space-16': type === 'up',
        },
        className,
      )}
      role="status"
