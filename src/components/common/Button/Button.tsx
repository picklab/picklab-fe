...
> = {
  filled: {
    active: {
      label:
        "bg-primary-50 hover:bg-primary-60 active:bg-primary-70 cursor-pointer",
  ...
  outlined: {
    active: {
      label:
        "group bg-gray-0 border border-gray-40 hover:bg-gray-5 active:bg-gray-20 cursor-pointer",
      textColor:
        "text-gray-90 group-hover:text-gray-70 group-active:text-gray-60",
    },
    disabled: {
  ...
  ["outline-filled"]: {
    active: {
      label:
        "group bg-gray-0 border border-primary-60 hover:bg-primary-5 active:bg-primary-10 cursor-pointer",
  ...
  return (
    <button
      className={clsx(
        ...
        disabled
          ? buttonStyleClass[buttonStyle].disabled.label
          : buttonStyleClass[buttonStyle].active.label, // 상태별 스타일
